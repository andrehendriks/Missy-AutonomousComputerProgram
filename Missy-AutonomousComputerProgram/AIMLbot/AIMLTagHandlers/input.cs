...
namespace AIMLbot.AIMLTagHandlers
{
    ...
    public class input : AIMLbot.Utils.AIMLTagHandler
    {
        ...
        {
            if (this.templateNode.Name.ToLower(CultureInfo.CurrentCulture) == "input")
            {
                        ...
                        if (this.templateNode.Attributes[0].Value.Length > 0)
                        {
                            try
                            {
                                ...
                                if (dimensions.Length == 2)
                                {
                                    ...
                                    {
                                        this.bot.writeToLog(Properties.Resource.String32 + this.templateNode.Attributes[0].Value + Properties.Resource.String33 + this.request.rawInput);
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        this.bot.writeToLog(Properties.Resource.String34 + this.templateNode.Attributes[0].Value + Properties.Resource.String35 + this.request.rawInput);
                                    }
                                }
                            }
                            catch
                            {
                                this.bot.writeToLog(Properties.Resource.String43 + this.templateNode.Attributes[0].Value + Properties.Resource.String44 + this.request.rawInput);
                            }
                        }
                    }
                }
