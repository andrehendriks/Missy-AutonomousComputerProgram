...
namespace AIMLbot
{
    ...
    public class Result
    {
            ...
            get
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        this.bot.writeToLog(Properties.Resource.String29 + this.RawInput + Properties.Resource.String30 + Environment.NewLine + paths.ToString() + Properties.Resource.String31 + this.user.UserID);
                        return string.Empty;
                    }
                }
            }
        ...
        private bool checkEndsAsSentence(string sentence)
        {
            ...
            {
                if (sentence.Trim().EndsWith(splitter, StringComparison.OrdinalIgnoreCase))
                {
                    return true;
                }
            }
